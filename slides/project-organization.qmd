...
`here` helps creating paths relative to the working directory
...
<br>
{{< fa hand-point-right >}} &nbsp;`here` will search for a `.Rproj` file (or `.here` file) to define the working directory
